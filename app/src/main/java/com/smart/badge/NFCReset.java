...
public class NFCReset extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nfcreset);
    ...
    public void onNewIntent(Intent intent)
    {
                ...
                NfcAdapter.ACTION_TECH_DISCOVERED.equals(action))
        {
            ...
            Log.e("Entree NewIntent","mmmmmmmmmm-onNewIntent");
           //todo make an handler for wrong reset on card
            NFCCore.emptyTage(intent);
            this.finish();
        }
    }
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if(listId.contains(eleve.matricul) )
                    {
                        ...
                        Intent intent = new Intent(NFCReset.this, DetailActivity.class);
